...
/** JSON قدیمی ممکن است attributeIds داشته باشد */
export function getPriceValueAttributeIds(
  item: ProductPriceData & { attributeIds?: string[] },
): string[] {
  return [...new Set(item.valueAttributeIds ?? item.attributeIds ?? [])];
}
