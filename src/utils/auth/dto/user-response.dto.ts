...
export class UserAdminSummaryDto {
  ...
  @ApiProperty({ example: 'تیم ادمین' })
  name: string;

  @ApiPropertyOptional({ example: '09363078987', nullable: true })
  phone?: string | null;
}
...
export class UserResponseDto {
  ...
  @ApiPropertyOptional({ type: UserAdminSummaryDto, nullable: true })
  admin: UserAdminSummaryDto | null;
