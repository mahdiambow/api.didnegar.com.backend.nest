...
export class ConvertUuidColumnsToUlid1790000000011 implements MigrationInterface {
  ...
  private readonly alters: Array<[string, string, string]> = [
    ...
    ['offer_products', 'id', 'CHAR(26) NOT NULL'],
    ['offer_products', 'sellerId', 'CHAR(26) NOT NULL'],
    ['offer_products', 'brandId', 'CHAR(26) NULL'],
    ['offer_products', 'productId', 'CHAR(26) NULL'],
    ['offer_products', 'offerId', 'CHAR(26) NULL'],
  ...
  private readonly recreateFks = [
    ...
    'ALTER TABLE `offer_products` ADD CONSTRAINT `FK_offer_products_sellerId` FOREIGN KEY (`sellerId`) REFERENCES `sellers`(`id`) ON DELETE RESTRICT ON UPDATE RESTRICT',
    'ALTER TABLE `offer_products` ADD CONSTRAINT `FK_offer_products_productId` FOREIGN KEY (`productId`) REFERENCES `products`(`id`) ON DELETE SET NULL ON UPDATE RESTRICT',
    'ALTER TABLE `offer_products` ADD CONSTRAINT `FK_offer_products_offerId` FOREIGN KEY (`offerId`) REFERENCES `seller_offers`(`id`) ON DELETE SET NULL ON UPDATE RESTRICT',
