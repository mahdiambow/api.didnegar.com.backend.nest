...
/**
 * Revert nullable seller_offer commercial fields —
 * price/stock/stockStatus و … دوباره الزامی با default.
 */
export class RestoreSellerOfferRequiredFields1790000000049
  implements MigrationInterface
{
  name = 'RestoreSellerOfferRequiredFields1790000000049';
