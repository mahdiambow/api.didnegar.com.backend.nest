...
export class SellerAuthController {
  ...
  loginOrSignup(@Body() dto: LoginOrSignupDto) {
    return this.authService.loginOrSignup(dto.mobile, 'seller');
  }
  ...
  verifyOtp(@Body() dto: VerifyOtpDto) {
    return this.authService.verifyOtp(dto.mobile, dto.code, 'seller');
  }
  ...
  setPassword(
    ...
    return this.authService.setPassword(req.user.sub, dto.password, 'seller');
  }
}
